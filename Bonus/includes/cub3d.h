...
void				ft_enemy(t_cube *cube, t_enemy *enemy,
						mlx_texture_t *texture);
...
void				ft_update_screen_res(t_cube *cube, int upscale,
						mlx_texture_t *texture);
void				ft_renderer(t_cube *cube, mlx_texture_t *texture,
						int start_x, int start_y);
void				ft_update_screen_buff(t_cube *cube, mlx_texture_t *texture,
						int new_w, int new_h);
void				ft_floor_ceiling(t_cube *cube);
bool				check_screen_limits(t_cube *cube, t_vect2 len);
void				ft_health(t_cube *cube, t_enemy *enemy);
void				ft_init_projectile(t_cube *cube, t_enemy *enemy,
						t_vect2 *dir);
...
bool				ft_projectile2(t_cube *cube, t_projectile *projectile,
						t_vars10 *vars);
bool				ft_projectile3(t_cube *cube, t_projectile *projectile,
						t_vars10 *vars);
bool				ft_projectile4(t_cube *cube, t_projectile *projectile,
						t_vars10 *vars);
void				ft_projectile6(t_cube *cube, t_projectile *projectile,
						t_vars10 *vars);
void				ft_draw_texture(t_cube *cube, t_ray *ray, t_vect2 start,
						t_vect2 end);
void				ft_rectangle(t_cube *cube, t_vect2 start_cords,
						t_vect2 end_cords, int color);
...
void				draw_map_entity(t_cube *cube, double pos_x, double pos_y,
						double angle);
...
void				ft_load_png(t_cube *cube, mlx_texture_t **tex_buff,
						char *path);
void				ft_projectile51(t_cube *cube, t_projectile *projectile,
						t_vars10 *vars);
